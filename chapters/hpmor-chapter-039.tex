...
Well, sounding wise wasn’t difficult. It was a lot easier than being intelligent, actually, since you didn’t have to say anything surprising or come up with any new insights. You just let your brain’s pattern-matching software complete the cliché, using whatever Deep Wisdom you’d stored previously.
...
“Love is more important than wisdom,” said Harry, just to test the limits of Dumbledore’s tolerance for blindingly obvious clichés completed by sheer pattern matching without any sort of detailed analysis.
...
And \emph{that} was when Harry realized that there was exactly one person who’d \emph{originally} told Professor McGonagall that the Dark Lord was still alive in the first place; and it was the crazy Headmaster of their madhouse of a school, who thought the world ran on clichés.
