...
% Chapter openings
% Definition of chapterOpeningQuote when they are desired to be printed
% FIXME: Make the environment definition switchable with a flag
...
% {%
% \\[1\baselineskip]%
% The next 2 lines were already disabled when OpeningQuote was displayed
%\newline%
%\rule[1ex]{\textwidth}{.1pt}\newline%x
% }
\excludecomment{chapterOpeningQuote}
